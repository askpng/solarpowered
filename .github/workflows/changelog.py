...
REGISTRY = "docker://ghcr.io/askpng/"
...
OTHER_NAMES = {
    "solarpowered": "### Desktop Images\n| | Name | Previous | New |\n| --- | --- | --- | --- |{changes}\n\n",
    "solarpowered-ex": "### Deck Images\n| | Name | Previous | New |\n| --- | --- | --- | --- |{changes}\n\n",
}

COMMITS_FORMAT = (
    "### Commits\n| Hash | Subject | Author |\n| --- | --- | --- |{commits}\n\n"
)
COMMIT_FORMAT = "\n| **[{short}](https://github.com/askpng/solarpowered/commit/{hash})** | {subject} | {author} |"
